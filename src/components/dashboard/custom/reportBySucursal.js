...
const npsColumns = [
  ...
  { field: 'name', type: 'string', width: 300, headerName: 'Sucursal' },
...
const CustomReport = () => {
  ...
  const questionId = '5fd8c4ed9653bc54c476102e' //id de pregunta de sucursal
  ...
  return (
    <BodyCard>
      <CardHeader title="Reporte por Sucursal" />
      <CardContent>
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <Card variant="outlined">
              <CardHeader title="NPS por Sucursal" />
              <CardContent>
                <Box sx={{ height: '500px' }}>
                  <DataGrid
                    columns={npsColumns}
          ...
          <Grid item xs={12}>
            <Card variant="outlined">
              <CardHeader title="CSAT por Sucursal" />
              <CardContent>
                <Box sx={{ height: '500px' }}>
                  <DataGrid
                    columns={csatColumns}
